...
m + geom_histogram(colour="White",fill = "steelblue",binwidth=500)+scale_y_continuous(breaks=seq(0,10))+
  ...
  annotate("text", x = 15000, y = 6.75, color="blue",
...
#add a vertical line at mean and median as caclulated
  ...
  geom_vline(xintercept = mean(daily_sum$steps,na.rm=TRUE),color="blue",size=1.1)+
  geom_vline(xintercept = median(daily_sum$steps,na.rm=TRUE),color="black",linetype="dashed",size=1.1)
...
paste(substr(sprintf("%04d",max_steps_time),1,2),":"
